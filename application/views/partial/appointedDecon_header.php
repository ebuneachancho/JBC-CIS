...
<html lang="en" ng-app="churchApp">
  <head>
    ...
    <title>Appointed Decon Dashboard| Jerusalem Baptist Convention (JBC)</title>
    <!-- Bootstrap core CSS -->
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav" ng-controller="">
      <a class="navbar-brand" href="#">Jerusalem Baptist Church (JBC)</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="Dashboard">
            <a class="nav-link" href="<?php echo base_url('index.php/load/page_/dashboard');?>">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Members">
            ...
            <ul class="sidenav-second-level collapse" id="collapseMember">
              ...
              <li><a href="<?php echo base_url('index.php/load/page_/addNewMember');?>">Add New Member</a></li>
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Sunday School">
            ...
            <ul class="sidenav-second-level collapse" id="collapseMulti">
              <li><a href="<?php echo base_url('index.php/load/page_/sundaySchoolDashboard');?>">Enter Church Offerings</a></li>
            </ul>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Events">
            ...
            <ul class="sidenav-second-level collapse" id="collapseEvent">
              ...
              <li><a href="<?php echo base_url('index.php/load/page_/addChurchEvent');?>">Add Church Event</a></li>
